...
function pushFilterToArray(filters, FilterClass, filterFunc, priority) {
    ...
    let func = acorn.parse(filterFunc.toString()), body = func.body[0], expression = body.expression, isArrowFunc = expression.type == 'ArrowFunctionExpression', filterFuncName;
